...
/**
 * Step 4 — Driver's License Capture
 *
 * Captures front and back of the DVLA Driver's License.
...
export default function LicenseCaptureScreen() {
  ...
  if (!CameraView || !useCameraPermissions) {
    return (
      <DriverStepShell
        ...
        onContinue={() => {
          setStep(4);
          router.push("/(onboarding)/driver/facial-verify" as Href);
        }}
      >
        <View style={styles.fallback}>
          <Ionicons name="car-outline" size={56} color="#6E7E91" />
  ...
  return (
    <CameraLicenseCapture
      ...
      setStep={setStep}
      setLicenseValidated={setLicenseValidated}
    />
  );
}

function CameraLicenseCapture({
  CameraViewComponent,
  ...
  const [phase, setPhase] = useState<CapturePhase>(() =>
    licenseFrontUri ? (licenseBackUri ? "preview" : "back") : "front",
  );
  const [capturing, setCapturing] = useState(false);
  const [frontUri, setFrontUri] = useState(licenseFrontUri);
  const [backUri, setBackUri] = useState(licenseBackUri);
      ...
      <ScreenContainer>
        <View style={styles.center}>
          ...
          <Text style={styles.permissionBody}>
            We need your camera to scan your driver&apos;s license for
            verification.
          </Text>
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalCard}>
          ...
          <Text style={styles.modalBody}>
            The image you captured does not appear to be a DVLA Driver&rsquo;s
            License. Please make sure you are scanning your driver&rsquo;s
            license, not your National ID or another document.
          </Text>
          <Pressable
          ...
          <View style={styles.headerRow}>
            <View style={styles.headerTextWrap}>
              <Text style={styles.headerTitle}>
                {isFront ? "Front of License" : "Back of License"}
              </Text>
              <Text style={styles.headerSubtitle}>
                DVLA License — {isFront ? "Side 1 of 2" : "Side 2 of 2"}
              </Text>
            </View>
          ...
          <DocumentViewfinder
            label={
              isFront
                ...
                : "Flip your license and align the back within the frame"
            }
          />
        </View>
...
const styles = StyleSheet.create({
  ...
  previewContainer: { width: "100%", gap: 16, marginTop: 8 },
  previewCard: {
    borderRadius: 16,
    overflow: "hidden",
